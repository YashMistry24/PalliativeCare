    ...
    <nav class="navbar navbar-inverse"  role="navigation">  
      ...
      <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li class="active"><a href="../Start/ITindex.jsp">Home</a></li>
            <li><a href="../Start/ITindex.jsp#about">About</a></li>
            <li><a href="../Start/ITindex.jsp#services">Service</a></li>              
            <li><a href="../Start/ITindex.jsp#contact">ContactUs</a></li>
          </ul>                     
        </div>
      </div>     
    </nav>
